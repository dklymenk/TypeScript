namespace ts {
    ...
    export function createLanguageService(
        ...
        const ls: LanguageService = {
            ...
            getSyntacticDiagnostics: withExcludedCodesFilter(getSyntacticDiagnostics),
            getSemanticDiagnostics: withExcludedCodesFilter(getSemanticDiagnostics),
            getSuggestionDiagnostics: withExcludedCodesFilter(getSuggestionDiagnostics),
            getCompilerOptionsDiagnostics: withExcludedCodesFilter(getCompilerOptionsDiagnostics),
